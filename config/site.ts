export const siteConfig = {
  ...
  heroDescription:
    "I design backend systems built to handle real load — secure APIs, role-based access control, and data pipelines that hold under production pressure. Open to backend and full-stack roles.",
  heroPrimaryCta: {
    label: "View My Work",
    href: "#projects",
  },
  ...
  about: {
    ...
    lightImageUrl: "/images/light-profile.png",
    darkImageUrl: "/images/dark-profile.png",
  ...
  navbar: {
    availabilityText: "Open to Backend and Full-Stack Roles",
  ...
  contact: {
    intro:
      "Looking for backend roles where architecture decisions matter — or full-stack products that need an engineer who thinks in systems, not just features. Open to freelance projects too. I respond within 24 hours.",
  },
  footer: {
    headline:
      "Architecting backend systems that scale. Available for backend and full-stack roles.",
